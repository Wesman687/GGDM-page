    ...
    <Layout title="Admin Panel">
      <div className="space-y-6">
        ...
        <div className="bg-white shadow sm:rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex justify-between items-center">
              <h3 className="text-lg leading-6 font-medium text-gray-900">Script Management</h3>
              <a
                href="/admin-scripts"
            ...
            <div className="mt-2">
              <p className="text-sm text-gray-600">
                Approve pending scripts, manage featured scripts, and review AI-generated content.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white shadow sm:rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex justify-between items-center">
              <h3 className="text-lg leading-6 font-medium text-gray-900">AI Rules Management</h3>
            ...
            <div className="mt-2">
              <p className="text-sm text-gray-600">
                Unified interface for managing AI rules, reviewing user suggestions, and analyzing training data for AI model enhancement.
              </p>
            </div>
          </div>
        </div>
